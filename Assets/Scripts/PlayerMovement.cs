...
public class PlayerMovement : MonoBehaviour
{
    ...
    public struct Stats
    {
        ...
        public void AddHealth(float changed)
        {
            health += changed;
            if (health > maxHealth)
            {
            ...
            Debug.Log("Health changed by " +changed);
        }
    }
    ...
    public void AddCoinCounter()
    {
        ...
        Debug.Log(playerStats.coinCounter);

        if (playerStats.coinCounter % 10 == 0)
        {
            playerStats.coinCounter = 0;
